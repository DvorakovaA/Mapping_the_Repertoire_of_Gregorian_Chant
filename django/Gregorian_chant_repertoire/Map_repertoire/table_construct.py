...
def get_table(communities : list[set [str]], feast_ids : list[str]) -> dict:
    '''
    ...
    for office in offices.keys():
        for i in range(len(communities)):
            ...
            if community_office_chants != []:
                ...
                chant_info = [{'incipit' : chant[0][2], 'cantus_id' : chant[0][1], 'freq' : "("+str(chant[1])+")"} for chant in ordered_freq]
                try:
